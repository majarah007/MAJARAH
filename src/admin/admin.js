...
async function saveShipping() {
  ...
  const zones = [{ name: 'Cairo', price: 43 }, { name: 'Giza', price: 43 }, { name: 'Alexandria', price: 51 }, { name: 'Qalyubia', price: 54 }, { name: 'Sharqia', price: 54 }, { name: 'Dakahlia', price: 54 }, { name: 'Gharbia', price: 54 }, { name: 'Monufia', price: 54 }, { name: 'Beheira', price: 54 }, { name: 'Damietta', price: 54 }, { name: 'Port Said', price: 54 }, { name: 'Ismailia', price: 54 }, { name: 'Suez', price: 54 }, { name: 'Kafr El Sheikh', price: 54 }, { name: 'Fayoum', price: 62 }, { name: 'Beni Suef', price: 62 }, { name: 'Minya', price: 62 }, { name: 'Asyut', price: 62 }, { name: 'Sohag', price: 72 }, { name: 'Qena', price: 72 }, { name: 'Luxor', price: 72 }, { name: 'Aswan', price: 72 }, { name: 'Red Sea', price: 86 }, { name: 'Matrouh', price: 86 }, { name: 'New Valley', price: 86 }, { name: 'North Sinai', price: 86 }, { name: 'South Sinai', price: 86 }];
  const shippingRates = {};
